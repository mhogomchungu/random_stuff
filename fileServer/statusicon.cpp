...
static QPixmap _icon( const QString& name,int count )
{
	...
	int size = pixmap.height() * 0.01 * 80 ;
...
void statusicon::setIconClickedActions( statusicon::clickActions actions )
{
	m_clickActions = std::move( actions ) ;
}
